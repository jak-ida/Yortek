...
@section('content')
    <div class="home-hero-scene position-relative text-white overflow-hidden" style="isolation: isolate;">
        ...
        <section class="home-hero position-relative" style="z-index: 10;">
            ...
            <a href="#why"
                class="hero-scroll-indicator hero-scroll-link position-absolute start-50 translate-middle-x d-flex flex-column align-items-center gap-2"
                aria-label="Scroll to content">
                <span class="hero-scroll-link__label">Explore</span>
